...
(function() {
  ...
  // Function to start the tour (simplified)
  window.startTour = function() {
    console.log('Starting tour...');
    // Switch to the first scene (entrance)
  ...
  function createLinkHotspotElement(hotspot) {
    ...
    // Create wrapper element to hold icon. (Ya no contendrá el tooltip)
    var wrapper = document.createElement('div');
    wrapper.classList.add('hotspot');
    wrapper.classList.add('link-hotspot');

    // Create icon element using Font Awesome based on target scene.
    ...
    // *** ELIMINADO: Se removió la creación del tooltip de texto. ***
  ...
  // Hide loading screen and display the initial scene
  ...
  // Display the initial scene after a short delay
  setTimeout(() => {
